...
* :x: Server side only (clients **do** need to install the mod)
...
* `zombieBusinessmanKhz` - an older businessman zombie.
    **New for 2.0:** This zombie can randomly spawn with different suits.
...
* `zombieFirefighterKhz` - a male firefighter zombie.
    **New for 2.0:** This zombie can randomly spawn with different firefighter outfits.
...
* `zombiePolicewomanKhz` - a large policewoman zombie. Be careful, she spits!
    **New for 2.0:** This zombie can randomly spawn with different law enforcement outfits.
    ![zombiePolicewomanKhz](./Screenshots/zombiePolicewomanKhz.jpg)
* `zombieMaleScrubsKhz` - A male health care worker zombie in medical scrubs.
    This zombie can randomly spawn with different colors of scrubs.
    ![zombieMaleScrubsKhz](./Screenshots/zombieMaleScrubsKhz.jpg)
* `zombieFemaleSoldierKhz` - A female soldier zombie.
    **New for 2.0:** This zombie can randomly spawn with different military outfits.
    ![zombieFemaleSoldierKhz](./Screenshots/zombieFemaleSoldierKhz.jpg)
* `zombieFemzombieMaleSoldierKhzaleSoldierKhz` - A new male soldier zombie.
    **New for 2.0:** This zombie can randomly spawn with different military outfits.
...
**New for 2.0:**
* _Charged_ versions of the burnt, businessman, businesswoman, cowgirl, generic female,
  office worker, firefighter, generic male, and medical scrubs zombies.
* _Infernal_ versions of the burnt, businessman, businesswoman, female lumberjack,
  office worker, firefighter, policewoman, and military zombies.

The new zombies should spawn with the appropriate vanilla zombies,
and should be added to the appropriate "kill zombie" challenges.
...
Compatibility patches are provided for:

* NPC Core
* Elemental Zombies Always

If another mod simply adds more zombies to the game,
it is probably already compatible with this mod.
